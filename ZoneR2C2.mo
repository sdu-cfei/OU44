...
model ZoneR2C2 "Simple zone"
  ...
  Modelica.Blocks.Continuous.Integrator integrator
    annotation (Placement(transformation(extent={{100,-144},{120,-124}})));
...
equation
  ...
  connect(heatFlowSensor.Q_flow, integrator.u) annotation (Line(points={{-14,
          -130},{-14,-130},{-14,-134},{98,-134}},      color={0,0,127}));
  connect(Qrad, integrator.y)
    annotation (Line(points={{226,-134},{121,-134}}, color={0,0,127}));
  ...
  connect(integrator1.y, vetot)
    annotation (Line(points={{121,-76},{174,-76},{174,-78},{226,-78}},
                                                   color={0,0,127}));
  ...
  connect(airMix.port_b, air.port)
    annotation (Line(points={{10,-40},{46,-40},{46,116}}, color={191,0,0}));
  ...
  connect(ventilation.y, integrator1.u)
    annotation (Line(points={{-143,-78},{-22,-78},{-22,-76},{98,-76}},
                                                   color={0,0,127}));
  ...
  connect(temperatureSensor.T, airMix.Ti) annotation (Line(points={{82,120},{90,
          120},{90,-60},{0,-60},{0,-50.8}},           color={0,0,127}));
  connect(ventilation.y, airMix.Vve) annotation (Line(points={{-143,-78},{-52,-78},
          {-52,-45},{-11,-45}},      color={0,0,127}));
  connect(max1.y, airMix.Tve) annotation (Line(points={{-113,-46},{-66,-46},{-66,
          -36.6},{-10.8,-36.6}},     color={0,0,127}));
