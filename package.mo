within ;
package OU44 "Virtual building models"
  extends Buildings.BaseClasses.BaseIcon;


  model ZoneR3C3 "single zone model"
  ...
  connect(co2.CO2, CO2) annotation (Line(points={{14.36,4},{68,4},{68,17},{135,
    ...
    connect(prescribedHeatFlow.port, Rindoor.port_a) annotation (Line(points={{-80,108},
          {-44,108},{-44,81},{-28,81}},            color={191,0,0}));
  ...
  connect(airMix.port_b, HC_air.port) annotation (Line(points={{8,-21},{14,-21},
          {14,-18},{20,-18},{20,88},{15,88}}, color={191,0,0}));
    annotation (
  ...
  annotation (
    ...
    ModelicaServices(version="3.2.2"),
      ...
      version="3",
    conversion(from(version="1", script="ConvertFromVirtual_1.mos"),
        noneFromVersion="2"));
end OU44;
